...
import { userInfoToDux } from "../../redux/reducer";
import "./Auth.css";
...
class Auth extends Component {
  ...
  registerUser() {
    ...
    axios
      ...
      .then((res) => {
        const { username, id, profile_pic } = res.data;
        this.props.userInfoToDux(username, id, profile_pic);
    ...
    return (
      <div className="auth-section-container">
        <form className="auth-form">
          ...
          />
          <h1 className="helo-logo-text">Helo</h1>
